...
def _network_dict(item: NetworkBatchResult) -> dict[str, Any]:
    ...
    return {
        ...
        "base_eligible_message_count": item.base_eligible_message_count,
        "routing_excluded_count": item.routing_excluded_count,
        "final_eligible_message_count": item.final_eligible_message_count,
        ...
        for item in batch.network_results:
            ...
            writer.writerow(
                (
                    ...
                    item.mode.value,
                    item.base_eligible_message_count,
                    item.routing_excluded_count,
                    item.final_eligible_message_count,
